...
class Test_Raja:
    ...
    # Test function to check the Menu page
    def test_check_Menu_page(self):
        ...
        assert self.is_element_visible(By.XPATH, self.locator.PIM_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Time_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Recruitment_xpath)
        sleep(2)
        assert self.is_element_visible(By.XPATH, self.locator.My_info_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Performance_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Dashboard_xpath)
        sleep(2)
        assert self.is_element_visible(By.XPATH, self.locator.Directory_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Maintenance_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Claim_xpath)
        assert self.is_element_visible(By.XPATH, self.locator.Buzz_xpath)
